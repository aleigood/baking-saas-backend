                    ...
                    sections: [
                        {
                            ...
                            evidence: '行1-4',
                            items: [
                                { rawName: '高粉', normalizedName: '高筋小麦粉', rawAmount: '1000', amount: 1000, unit: 'g', note: null, isFlour: true, waterContent: null, evidence: '行1' },
                                { rawName: '水', normalizedName: '水', rawAmount: '650', amount: 650, unit: 'g', note: null, isFlour: false, waterContent: 100, evidence: '行2' },
                            ],
                        },
                        {
                            name: '菠菜玉米恰巴塔',
                            ...
                            evidence: '行5-6',
                            items: [
                                { rawName: '菠菜', normalizedName: '菠菜', rawAmount: '200', amount: 200, unit: 'g', note: null, isFlour: false, waterContent: null, evidence: '行5' },
                            ],
                        },
                    ],
                    products: [],
                ...
                },
                {
                    ...
                    sections: [
                        ...
                        },
                        {
                            ...
                            evidence: '行3-4',
                            items: [
                                { rawName: '冷冻树莓', normalizedName: '冷冻树莓', rawAmount: '1000', amount: 1000, unit: 'g', note: null, isFlour: false, waterContent: null, evidence: '行3' },
                                { rawName: '糖', normalizedName: '糖', rawAmount: '120', amount: 120, unit: 'g', note: null, isFlour: false, waterContent: null, evidence: '行4' },
                            ],
                        },
                    ],
                    products: [],
                    ...
                    sections: [
                        {
                            ...
                            items: [
                                { rawName: '高粉', normalizedName: '高筋小麦粉', rawAmount: '1000', amount: 1000, unit: 'g', note: null, isFlour: true, waterContent: null, evidence: '行1' },
                                { rawName: '水', normalizedName: '水', rawAmount: '650', amount: 650, unit: 'g', note: null, isFlour: false, waterContent: 100, evidence: '行2' },
                                { rawName: '后加水', normalizedName: '水', rawAmount: '100', amount: 100, unit: 'g', note: null, isFlour: false, waterContent: 100, evidence: '行3' },
                                { rawName: '低糖干酵母', normalizedName: '半干酵母', rawAmount: '3', amount: 3, unit: 'g', note: null, isFlour: false, waterContent: null, evidence: '行4' },
                            ],
                        },
                    ],
                    products: [],
